...
<main class="flex flex-col w-full max-w-[1280px] mx-auto px-16 gap-9 mt-16">
    <div class="flex flex-col gap-6">
        <div class="flex items-center gap-2">
            ...
            <p class="font-semibold text-lg leading-[22px] text-patungan-grey last:text-patungan-black">Netflix</p>
            <p class="font-semibold leading-5 text-patungan-grey">></p>
            ...
            <div class="flex flex-col p-6 gap-6">
                ...
                <div class="flex flex-col rounded-3xl border border-patungan-border p-4 gap-4">
                    <div class="flex items-center justify-between">
                        <p class="font-extrabold text-2xl leading-[30px]">Rp46.500</p>
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <label class="flex flex-col gap-4">
                        ...
                        <div class="flex items-center rounded-3xl border border-patungan-border p-6 gap-4 bg-patungan-bg-grey focus-within:border-patungan-orange transition-all duration-300">
                            ...
                            <input type="text" name="name" id="name" class="appearance-none outline-none bg-patungan-bg-grey w-full font-bold text-xl leading-[25px] placeholder:text-patungan-black" placeholder="Enter your name">
                        </div>
                    </label>
                    <label class="flex flex-col gap-4">
                    ...
                    <label class="flex flex-col gap-4">
                        ...
                        <div class="flex items-center rounded-3xl border border-patungan-border p-6 gap-4 bg-patungan-bg-grey focus-within:border-patungan-orange transition-all duration-300">
                            ...
                            <div class="flex h-6 border border-patungan-border"></div>
                            <input type="email" name="email" id="email" class="appearance-none outline-none bg-patungan-bg-grey w-full font-bold text-xl leading-[25px] placeholder:text-patungan-black" placeholder="Enter your email address">
                        </div>
                    </label>
                </div>
                <div class="flex flex-col gap-5">
