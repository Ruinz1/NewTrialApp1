                    ...
                    <div class="flex flex-col p-8 gap-6">
                        ...
                        <div class="flex flex-col rounded-3xl border border-patungan-border p-4 gap-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <p class="font-medium text-lg leading-[22px] text-patungan-grey">Lorem Ipsum~</p>
                            </div>
                        </div>
                        <div class="flex flex-col gap-3">
                            <h2 class="font-bold text-xl leading-[25px]">About Netflix</h2>
                            <p class="font-semibold text-lg leading-[32px] text-patungan-grey">{{$product->about}}</p>
                        </div>
                        <div class="flex flex-col gap-3">
                            <h2 class="font-bold text-xl leading-[25px]">Netflix Feature’s</h2>
